namespace Xi.Models.Tests.Game
{
  ...
  public class PlayerTests
  {
    ...
    {
      var won = new Player(1, "name1", "email1", 1000, null, "{}", false);
      var lost = new Player(1, "name2", "email2", 1000, null, "{}", false);
    ...
    {
      var won = new Player(1, "name1", "email1", 1100, null, "{}", false);
      var lost = new Player(1, "name2", "email2", 1000, null, "{}", false);
    ...
    {
      var won = new Player(1, "name1", "email1", 1000, null, "{}", false);
      var lost = new Player(1, "name2", "email2", 1100, null, "{}", false);
