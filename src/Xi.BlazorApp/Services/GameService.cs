...
public class GameService : IGameService
{
  ...
  public bool CanExtendClock(int playerId, int gameId)
  {
    ...
    var hoursPastClockRunningOut = (DateTimeOffset.UtcNow - game.ClockRunsOutAt).Value.TotalHours;
  ...
  public GameModel BuyExtraTime(int playerId, int gameId)
  {
    ...
    game.ClockRunsOutAt = DateTimeOffset.UtcNow + TimeSpan.FromHours(12);
